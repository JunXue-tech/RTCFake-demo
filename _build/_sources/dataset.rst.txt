...
.. raw:: html
    ...
    <h1>Offline-Online Dataset</h1>
    
    <div class="note-box">
    <strong>Dataset Description:</strong> This dataset contains offline and online speech samples for audio synthesis, voice conversion, and transmission analysis.
    All audio samples require manual playback. Click the play button on each audio player to listen.
    </div>
    </div>

    <!-- ============ OFFLINE DATA ============ -->
    <div class="dataset-section">
    <h2 class="dataset-title">1. Offline Data</h2>
    
    <!-- 1.1 TTS Dataset -->
    <div class="dataset-subtitle">1.1 Text-to-Speech (TTS)</div>
    ...
    <table class="pdf-table">
        <thead>
            <tr>
                ...
                <th>Reference</th>
                <th>F5-TTS</th>
                <th>OpenAudio-S1-mini</th>
                <th>VOXCPM</th>
                <th>LLaSA</th>
                <th>IndexTTS2</th>
                <th>Doubao-Seed-TTS2</th>
                <th>SparkTTS</th>
            </tr>
        </thead>
        <tbody>
            ...
            <tr>
                ...
                <td>Chinese</td>
                <td class="text-cell">
                    <div class="text-collapsible" onclick="toggleText(this)">
                        <div class="text-preview">
                            我们一起走进这座千年古城，探寻那些藏在历史深处的秘密。
                        </div>
                        <div class="text-full" style="display:none;">
                            我们一起走进这座千年古城，探寻那些藏在历史深处的秘密。
                        </div>
                        <div class="text-toggle">[Full Text]</div>
                    </div>
                </td>
                <td class="audio-cell">
            ...
            <tr>
                ...
                <td class="text-cell">
                    <div class="text-collapsible" onclick="toggleText(this)">
                        <div class="text-preview">
                            "The dog was always ravenous, and swallered the heap  kerchunk! ""Pretty soon along come an explosion  so the man said."
                        </div>
                        <div class="text-full" style="display:none;">
                            "The dog was always ravenous, and swallered the heap  kerchunk! ""Pretty soon along come an explosion  so the man said."
                        </div>
            ...
            <tr>
                ...
                <td class="text-cell">
                    <div class="text-collapsible" onclick="toggleText(this)">
                        <div class="text-preview">
                            遵循均衡饮食的原则，我们可以为身体提供全面的营养支持，促进健康，预防疾病。
                        </div>
                        <div class="text-full" style="display:none;">
                            遵循均衡饮食的原则，我们可以为身体提供全面的营养支持，促进健康，预防疾病。
                        </div>
    ...
    <!-- 1.2 VC Dataset -->
    <div class="dataset-subtitle">1.2 Voice Conversion (VC)</div>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="audio-cell">
                    <div class="audio-player">
                        <audio controls preload="none">
                            <source src="_static/audio/wav_demo/offline/2_VC/train/EN/100_F_02_baum_sea_fairi_48_real.wav" type="audio/wav">
                        </audio>
                    </div>
                </td>
                <td class="audio-cell">
                    <div class="audio-player">
                        <audio controls preload="none">
                            <source src="_static/audio/wav_demo/offline/2_VC/train/EN/ref_wav/107_M_tomab_01_twain_48.wav" type="audio/wav">
                        </audio>
                    </div>
                </td>
                <td class="audio-cell">
            ...
            <tr>
                ...
                <td class="audio-cell">
                    <div class="audio-player">
                        <audio controls preload="none">
                            <source src="_static/audio/wav_demo/offline/2_VC/dev/EN/3318_F_linco_353_willi_10_real.wav" type="audio/wav">
                        </audio>
                    </div>
                </td>
                <td class="audio-cell">
                    <div class="audio-player">
                        <audio controls preload="none">
                            <source src="_static/audio/wav_demo/offline/2_VC/dev/EN/ref_wav/3483_M_thebe_11_marsh_30.wav" type="audio/wav">
                        </audio>
                    </div>
                </td>
                <td class="audio-cell">
            ...
            <tr>
                ...
                <td class="audio-cell">
                    <div class="audio-player">
                        <audio controls preload="none">
                            <source src="_static/audio/wav_demo/offline/2_VC/test/CN/081_24_F_JKYS_070_real.wav" type="audio/wav">
                        </audio>
                    </div>
                </td>
                <td class="audio-cell">
                    <div class="audio-player">
                        <audio controls preload="none">
                            <source src="_static/audio/wav_demo/offline/2_VC/test/CN/ref_wav/102_24_M_KJ_013.wav" type="audio/wav">
                        </audio>
                    </div>
                </td>
                <td class="audio-cell">
            ...
            <tr>
                ...
                <td class="audio-cell">
                    <div class="audio-player">
                        <audio controls preload="none">
                            <source src="_static/audio/wav_demo/offline/2_VC/test/EN/2827_M_furth_04_defoe_62_real.wav" type="audio/wav">
                        </audio>
                    </div>
                </td>
                <td class="audio-cell">
                    <div class="audio-player">
                        <audio controls preload="none">
                            <source src="_static/audio/wav_demo/offline/2_VC/test/EN/ref_wav/2910_F_millo_33_eliot_51.wav" type="audio/wav">
                        </audio>
                    </div>
                </td>
                <td class="audio-cell">
    ...
    <!-- 1.3 Manipulations Dataset -->
    <div class="dataset-subtitle">1.3 Audio Manipulations</div>
    ...
    <table class="pdf-table">
        ...
        <tbody>
            <!-- Clean Row -->
            <tr>
                <td class="noise-type">Clean</td>
                <td class="audio-cell">
                    <div class="audio-player">
                        <audio controls preload="none">
                            <source src="_static/audio/wav_demo/offline/3_Manipulations/noise_keyboard/001_24_F_JKYS_014_real.wav" type="audio/wav">
                        </audio>
                    </div>
                </td>
                <td class="audio-cell">
                    <div class="audio-player">
                        <audio controls preload="none">
                            <source src="_static/audio/wav_demo/offline/3_Manipulations/noise_footsteps/001_24_F_JKYS_012_real.wav" type="audio/wav">
                        </audio>
                    </div>
                </td>
                <td class="audio-cell">
                    <div class="audio-player">
                        <audio controls preload="none">
                            <source src="_static/audio/wav_demo/offline/3_Manipulations/noise_rain/001_24_F_JKYS_017_real.wav" type="audio/wav">
                        </audio>
                    </div>
                </td>
                <td class="audio-cell">
                    <div class="audio-player">
                        <audio controls preload="none">
                            <source src="_static/audio/wav_demo/offline/3_Manipulations/noise_coffee/001_24_F_JKYS_028_real.wav" type="audio/wav">
                        </audio>
                    </div>
                </td>
                <td class="audio-cell">
                    <div class="audio-player">
                        <audio controls preload="none">
                            <source src="_static/audio/wav_demo/offline/3_Manipulations/noise_office/001_24_F_JKYS_001_real.wav" type="audio/wav">
                        </audio>
                    </div>
                </td>
                <td class="audio-cell">
                    <div class="audio-player">
                        <audio controls preload="none">
                            <source src="_static/audio/wav_demo/offline/3_Manipulations/echo/001_24_F_JKYS_146_real.wav" type="audio/wav">
                        </audio>
                    </div>
                </td>
            </tr>
            <!-- Noisy Row -->
            <tr>
                <td class="noise-type">Noisy</td>
                <td class="audio-cell">
                    <div class="audio-player">
                        <audio controls preload="none">
                            <source src="_static/audio/wav_demo/offline/3_Manipulations/noise_keyboard/001_24_F_JKYS_014_real_keyboard.wav" type="audio/wav">
                        </audio>
                    </div>
                </td>
                <td class="audio-cell">
                    <div class="audio-player">
                        <audio controls preload="none">
                            <source src="_static/audio/wav_demo/offline/3_Manipulations/noise_footsteps/001_24_F_JKYS_012_real_footsteps.wav" type="audio/wav">
                        </audio>
                    </div>
                </td>
                <td class="audio-cell">
                    <div class="audio-player">
                        <audio controls preload="none">
                            <source src="_static/audio/wav_demo/offline/3_Manipulations/noise_rain/001_24_F_JKYS_017_real_rain.wav" type="audio/wav">
                        </audio>
                    </div>
                </td>
                <td class="audio-cell">
                    <div class="audio-player">
                        <audio controls preload="none">
                            <source src="_static/audio/wav_demo/offline/3_Manipulations/noise_coffee/001_24_F_JKYS_028_real_coffee.wav" type="audio/wav">
                        </audio>
                    </div>
                </td>
                <td class="audio-cell">
                    <div class="audio-player">
                        <audio controls preload="none">
                            <source src="_static/audio/wav_demo/offline/3_Manipulations/noise_office/001_24_F_JKYS_001_real_office.wav" type="audio/wav">
                        </audio>
                    </div>
                </td>
                <td class="audio-cell">
                    <div class="audio-player">
                        <audio controls preload="none">
                            <source src="_static/audio/wav_demo/offline/3_Manipulations/echo/001_24_F_JKYS_146_real_echo.wav" type="audio/wav">
                        </audio>
                    </div>
                </td>
            </tr>
    ...
    <!-- ============ ONLINE DATA ============ -->
    <div class="dataset-section">
    <h2 class="dataset-title">2. Online Data</h2>
    
    <!-- 2.1 Real-Fake Comparison -->
    <div class="dataset-subtitle">2.1 Real vs Fake Comparison</div>
    
    <div class="note-box">
    <strong>Real Speech:</strong> Original and platform-transmitted versions
    </div>
    ...
    <table class="pdf-table">
        ...
        <tbody>
            ...
            <tr class="platform-row">
                <td class="platform-cell">Real</td>
                <td class="audio-cell">
                    <div class="audio-player">
                        <audio controls preload="none">
            ...
            <!-- Fake Row -->
            <tr class="platform-row">
                <td class="platform-cell">Fake_IndexTTS2</td>
                <td class="audio-cell">
                    <div class="audio-player">
                        <audio controls preload="none">
    ...
    <!-- 2.2 Clean-Noisy Comparison -->
    <div class="dataset-subtitle">2.2 Clean vs Noisy Comparison</div>
    
    <div class="note-box">
    <strong>Clean and Noisy Speech with Spectrograms:</strong> Original and platform-transmitted versions
    </div>
    ...
    <table class="pdf-table">
        ...
        <tbody>
            <!-- Clean Row -->
            <tr class="platform-row">
                <td class="platform-cell">Clean</td>
            ...
            <!-- Noisy Row -->
            <tr class="platform-row">
                <td class="platform-cell">Noisy (Rain)</td>
                <td class="spectrogram-cell">
                    <div class="audio-player">
                        <audio controls preload="none">
    ...
    <!-- 2.3 Noisy Lark Comparison -->
    <div class="dataset-subtitle">2.3 Noisy Lark Comparison</div>
    
    <div class="note-box">
    <strong>Different noisy speeches transmitted through Lark platform</strong>
    </div>
    ...
    <table class="pdf-table">
        ...
        <tbody>
            <!-- Noise_keyboard -->
            <tr>
                <td class="noise-type">Noise_keyboard</td>
                <td class="spectrogram-cell">
                    <div class="audio-player">
                        <audio controls preload="none">
            ...
            <!-- Noise_footsteps -->
            <tr>
                <td class="noise-type">Noise_footsteps</td>
                <td class="spectrogram-cell">
                    <div class="audio-player">
                        <audio controls preload="none">
            ...
            <!-- Noise_rain -->
            <tr>
                <td class="noise-type">Noise_rain</td>
                <td class="spectrogram-cell">
                    <div class="audio-player">
                        <audio controls preload="none">
            ...
            <!-- Noise_coffee -->
            <tr>
                <td class="noise-type">Noise_coffee</td>
                <td class="spectrogram-cell">
                    <div class="audio-player">
                        <audio controls preload="none">
            ...
            <!-- Noise_office -->
            <tr>
                <td class="noise-type">Noise_office</td>
                <td class="spectrogram-cell">
                    <div class="audio-player">
                        <audio controls preload="none">
    ...
    function toggleText(element) {
        ...
        const toggle = element.querySelector('.text-toggle');
